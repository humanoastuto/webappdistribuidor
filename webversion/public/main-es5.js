...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AuthenticationService = /** @class */ (function () {
                function AuthenticationService(afAuth // Inject Firebase auth service
                ) {
                    this.afAuth = afAuth;
                }
                // Sign up with email/password
                AuthenticationService.prototype.SignUp = function (email, password, cpass) {
                    if (password === cpass) {
                ...
                AuthenticationService.prototype.delete = function (email, password, cpass) {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    if (!(password === cpass)) {
                                        return [2 /*return*/, console.error("Las contrasenas son diferentes")];
                                    }
                                    _a.label = 1;
                                case 1:
                                    _a.trys.push([1, 3, , 4]);
                ...
                AuthenticationService.prototype.update = function (email, password, cpass, nuevoEmail, newPass) {
                    if (!(password === cpass)) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var CrudService = /** @class */ (function () {
                ...
                CrudService.prototype.read_Productos = function () {
                    return this.firestore.collection('Productos').snapshotChanges();
                };
                CrudService.prototype.update_Producto = function (recordID, record) {
                    this.firestore.doc('Productos/' + recordID).update(record);
                };
                CrudService.prototype.delete_Producto = function (record_id) {
                    this.firestore.doc('Productos/' + record_id).delete();
                };
                CrudService.prototype.create_NewProveedor = function (record) {
                ...
                CrudService.prototype.delete_Proveedor = function (record_id) {
                    this.firestore.doc('Proveedores/' + record_id).delete();
                };
                CrudService.prototype.create_NewVendedor = function (record) {
                ...
                CrudService.prototype.update_Vendedor = function (recordID, record) {
                    this.firestore.doc('Vendedores/' + recordID).update(record);
                };
                CrudService.prototype.delete_Vendedor = function (record_id) {
                    this.firestore.doc('Vendedores/' + record_id).delete();
                };
                CrudService.prototype.read_Ventas = function () {
                    return this.firestore.collection('Ventas').snapshotChanges();
                };
                CrudService.prototype.read_Pedidos = function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var MapaComponent = /** @class */ (function () {
                function MapaComponent(crudService) {
                ...
                MapaComponent.prototype.ngOnInit = function () {
                    ...
                    this.crudService.read_Vendedor().subscribe(function (data) {
                        _this.vendedores = data.map(function (e) {
                            _this.crearmarkersv(e.payload.doc.data()['Email'], e.payload.doc.data()['Latitud'], e.payload.doc.data()['Longitud']);
                        });
                    });
                    this.crudService.read_Proveedores().subscribe(function (data) {
                        _this.proveedores = data.map(function (e) {
                            _this.crearmarkers(e.payload.doc.data()['Proveedor'], e.payload.doc.data()['Latitud'], e.payload.doc.data()['Longitud']);
                        });
                    });
                    this.crudService.read_Pedidos().subscribe(function (data) {
                        _this.pedidos = data.map(function (e) {
                            _this.crearmarkerspe(e.payload.doc.data()['Nombre'], e.payload.doc.data()['Latitud'], e.payload.doc.data()['Longitud']);
                        });
                    });
                    this.crudService.read_Ventas().subscribe(function (data) {
                        _this.ventas = data.map(function (e) {
                            _this.crearmarkersve(e.payload.doc.data()['Usuario'], e.payload.doc.data()['Latitud'], e.payload.doc.data()['Longitud']);
                        });
                    });
                };
                MapaComponent.prototype.crearmarkers = function (a, b, c) {
                    this.markers.push({
                        label: a,
                        lat: parseFloat(b),
                        lng: parseFloat(c),
                ...
                MapaComponent.prototype.crearmarkersv = function (a, b, c) {
                    this.markers.push({
                        label: a,
                        lat: parseFloat(b),
                        lng: parseFloat(c),
                ...
                MapaComponent.prototype.crearmarkerspe = function (a, b, c) {
                    this.markers.push({
                        label: a,
                        lat: parseFloat(b),
                        lng: parseFloat(c),
                ...
                MapaComponent.prototype.crearmarkersve = function (a, b, c) {
                    this.markers.push({
                        label: a,
                        lat: parseFloat(b),
                        lng: parseFloat(c),
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            /* harmony import */ var _crud_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../crud.service */ "./src/app/crud.service.ts");
            var NuevoproveedorComponent = /** @class */ (function () {
                function NuevoproveedorComponent(crudService) {
                    this.crudService = crudService;
                ...
                NuevoproveedorComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.crudService.read_Proveedores().subscribe(function (data) {
                        _this.proveedores = data.map(function (e) {
                            return {
                ...
                NuevoproveedorComponent.prototype.CreateRecord = function () {
                    var _this = this;
                    if (this.prov !== "" && this.cod !== "" && this.desc !== "") {
                        ...
                        this.crudService.create_NewProveedor(record).then(function (resp) {
                            _this.prov = "";
                            _this.cod = "";
                            _this.desc = "";
                            _this.latit = "";
                ...
                NuevoproveedorComponent.prototype.RemoveRecord = function (rowID) {
                    this.crudService.delete_Proveedor(rowID);
                };
                NuevoproveedorComponent.prototype.EditRecord = function (record) {
                    record.isEdit = true;
                    record.EditProv = record.Proveedor;
                    record.EditCod = record.Codigo;
                    record.EditDesc = record.Descripcion;
                };
                NuevoproveedorComponent.prototype.UpdateRecord = function (recordRow) {
                    var record = {};
                ...
                return NuevoproveedorComponent;
            }());
            NuevoproveedorComponent.ctorParameters = function () { return [
                { type: _crud_service__WEBPACK_IMPORTED_MODULE_2__["CrudService"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ProductoComponent = /** @class */ (function () {
                function ProductoComponent(crudService) {
                    this.crudService = crudService;
                    this.title = 'Plantilla de productos';
                }
                ProductoComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.crudService.read_Productos().subscribe(function (data) {
                        _this.productos = data.map(function (e) {
                            return {
                                id: e.payload.doc.id,
                                isEdit: false,
                                Proveedor: e.payload.doc.data()['Proveedor'],
                ...
                ProductoComponent.prototype.CreateRecord = function () {
                    var _this = this;
                    if (this.prov !== "" && this.prod !== "" && this.desc !== "") {
                        ...
                        this.crudService.create_NewProducto(record).then(function (resp) {
                            _this.prov = "";
                            _this.prod = "";
                            _this.desc = "";
                            _this.prec = "";
                ...
                ProductoComponent.prototype.RemoveRecord = function (rowID) {
                    this.crudService.delete_Producto(rowID);
                };
                ProductoComponent.prototype.EditRecord = function (record) {
                    record.isEdit = true;
                    record.EditProv = record.Proveedor;
                    record.EditProd = record.Producto;
                    record.EditDesc = record.Descripcion;
                };
                ProductoComponent.prototype.UpdateRecord = function (recordRow) {
                    var record = {};
                    record['Proveedor'] = recordRow.EditProv;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ProveedorComponent = /** @class */ (function () {
                function ProveedorComponent(crudService) {
                    this.crudService = crudService;
                ...
                ProveedorComponent.prototype.RemoveRecord = function (rowID) {
                    this.crudService.delete_Proveedor(rowID);
                };
                ProveedorComponent.prototype.EditRecord = function (record) {
                    record.isEdit = true;
                    record.EditProv = record.Proveedor;
                    record.EditCod = record.Codigo;
                    record.EditDesc = record.Descripcion;
                ...
                ProveedorComponent.prototype.UpdateRecord = function (recordRow) {
                    var record = {};
                    record['Proveedor'] = recordRow.EditProv;
                    record['Codigo'] = recordRow.EditCod;
            ...
            ProveedorComponent.ctorParameters = function () { return [
                { type: _crud_service__WEBPACK_IMPORTED_MODULE_2__["CrudService"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var VendedorComponent = /** @class */ (function () {
                function VendedorComponent(crudService, afAuth, authenticationService) {
                    this.crudService = crudService;
                    this.afAuth = afAuth;
                ...
                VendedorComponent.prototype.ngOnInit = function () {
                    ...
                    this.crudService.read_Vendedor().subscribe(function (data) {
                        ...
                        console.log(_this.vendedores);
                    });
                };
                VendedorComponent.prototype.resetForm = function () {
                    this.email = '';
                    this.passrd = '';
                    this.cpassrd = '';
                    this.newEmail = '';
                ...
                VendedorComponent.prototype.CreateRecord = function () {
                    var _this = this;
                    var record = {};
                    if (this.passrd == this.cpassrd && this.passrd !== "" && this.email !== "") {
                        ...
                        this.crudService.create_NewVendedor(record).then(function (resp) {
                            _this.resetForm();
                            console.log(resp);
                        })
                            .catch(function (error) {
                ...
                VendedorComponent.prototype.RemoveRecord = function (rowID) {
                    this.crudService.delete_Vendedor(rowID);
                };
                VendedorComponent.prototype.EditRecord = function (record) {
                    record.isEdit = true;
                    record.EditEmail = record.Email;
                    record.EditPass = record.Password;
                };
                VendedorComponent.prototype.UpdateRecord = function (recordRow) {
                    var record = {};
                ...
                VendedorComponent.prototype.registrar = function () {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        var res, error_2;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 1:
                                    _a.trys.push([1, 3, , 4]);
                                    return [4 /*yield*/, this.afAuth.auth.createUserWithEmailAndPassword(this.email, this.passrd)];
                                case 2:
                                    res = _a.sent();
                                    console.log(res);
                                    return [3 /*break*/, 4];
                ...
                VendedorComponent.prototype.borrar = function () {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        var res, error_3;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 1:
                                    _a.trys.push([1, 3, , 4]);
                                    return [4 /*yield*/, this.afAuth.auth.signInWithEmailAndPassword(this.email, this.passrd)];
                                case 2:
                                    res = _a.sent();
                                    this.afAuth.auth.currentUser.delete();
                                    console.log("Borrado");
                ...
                VendedorComponent.prototype.getUserByEmail = function () {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        var res, error_4;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
